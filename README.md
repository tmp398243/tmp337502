...
| [**Documentation**][docs-latest-url]    | [<img src="https://img.shields.io/badge/docs-latest-blue.svg" alt = "doc badge" height="30">][docs-latest-url] [<img src="https://github.com/tmp398243/tmp337502/actions/workflows/docs.yaml/badge.svg?branch=main" alt = "doc badge" height="30">][docs-build-url] |
|----------------------|--------------------------------------------------|
| [**CI tests**][ci-tests-url]        | [<img src="https://github.com/tmp398243/tmp337502/actions/workflows/ci-tests.yaml/badge.svg?branch=main" alt = "CI badge" height="30">][ci-tests-url] |
| [**Code Coverage**][codecov-url]    | [<img src="https://tmp398243.github.io/tmp337502/coverage/badge.svg" alt = "coverage badge" height="30">][codecov-url] |

[docs-latest-url]: https://tmp398243.github.io/tmp337502
[ci-tests-url]: https://github.com/tmp398243/tmp337502/actions/workflows/ci-tests.yaml?query=branch%3Amain
[docs-build-url]: https://github.com/tmp398243/tmp337502/actions/workflows/docs.yaml?query=branch%3Amain
[codecov-url]: https://tmp398243.github.io/tmp337502/coverage/
...
- `src/`: Contains the main source code for the project with the entrypoint being `src/NormalizingFlowFilters.jl`.
